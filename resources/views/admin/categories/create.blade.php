...
@section('content')
    <div class="space-y-6 max-w-2xl">
        <!-- Header -->
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Tambah Kategori Baru</h1>
            <p class="text-slate-600 mt-2">Isi formulir di bawah untuk menambahkan kategori baru</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" placeholder="Contoh: Seminar, Workshop, Konser"
                        value="{{ old('name') }}"
